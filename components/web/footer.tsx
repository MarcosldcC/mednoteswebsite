  ...
  return (
    <footer className="bg-mn-green-900 text-mn-surface">
      <div className="container mx-auto px-6 md:px-10 lg:px-16 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              <Image src="/images/mednoteslogo.svg" alt="MedNotes" width={120} height={32} className="h-8 w-auto" />
            </div>
            ...
            <ul className="space-y-2">
              {footerLinks.produto.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-mn-surface/70 hover:text-mn-surface transition-colors text-sm"
                  >
                    {link.label}
                  </Link>
                </li>
        ...
        <div className="border-t border-mn-border-light mt-8 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-mn-surface/60 text-sm">
            © {new Date().getFullYear()} MedNotes. Todos os direitos reservados.
          </p>
          <div className="flex gap-4">
            <span
              className="text-mn-surface/50 cursor-not-allowed"
              title="Em breve"
